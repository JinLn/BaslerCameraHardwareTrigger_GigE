...
///
/// \brief CameraGrabberBasler::Camera initializationStopGrab
/// \return
///
...
void CameraGrabberBasler::StartGrab(){
    ...
    try{
        ...
        // OnImageGrabbed(Pylon::CBaslerUsbInstantCamera &camera,　const Pylon::CBaslerUsbGrabResultPtr &ptrGrabResult)
